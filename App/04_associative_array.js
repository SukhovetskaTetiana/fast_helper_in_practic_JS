...
// Task 1
// При нажатии b-1 выполняете функцию f1. Функция должна вывести
// в out-1 значение сохраненное под ключем two из массива a1.
...
// значения hi из массива a3. Возвратите результирующую строку значение.
// Вывод - через пробел.
// Вывод, как и в предыдущем задании пишем "руками"
...
// при нажатии кнопки b-4. Формат вывода - ключ пробел значение +' <br>'.
...
// Task 16
// При нажатии b-16 выполняете функцию f16. Функция должна в
// out-16 выводить элементы name вложенных массивов в a16.
// Вывод через пробел.
...
// вывести цвет ветки станции которую пользователь ввел в i-19.
...
function f19() {
  let stInput = document.querySelector(".i-19").value;
  let out = document.querySelector(".out-19");

  for (let key in a19) {
    for (let i = 0; i < a19[key].length; i++) {
      if (a19[key][i].toLowerCase() === stInput.toLowerCase()) {
        out.innerHTML = key;
      }
    }
  }
